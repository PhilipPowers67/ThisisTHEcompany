...
function addNewRole() {
  inquirer
    ...
    // .then(answer => {
    //   const params = [answer.addRoles, answer.salary];

    //   const departRole = `SELECT department_name, id FROM departments`;

    //   connection.promise().query(departRole, (err, data) => {
    //     if (err) throw err;
    //     const depart = data.map(({ department_name, id }) => ({
